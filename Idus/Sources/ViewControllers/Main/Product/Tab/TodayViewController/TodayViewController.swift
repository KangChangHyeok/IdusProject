...
class TodayViewController: UIViewController {
    ...
    @IBOutlet weak var todayTableView: UITableView! {
        didSet {
            ...
            todayTableView.register(UINib(nibName: MenuTableViewCell.className, bundle: nil), forCellReuseIdentifier: MenuTableViewCell.cellId)
            todayTableView.register(UINib(nibName: CategoryCell.className, bundle: nil), forCellReuseIdentifier: CategoryCell.cellId)
            todayTableView.register(UINib(nibName: Category2Cell.className, bundle: nil), forCellReuseIdentifier: Category2Cell.cellId)
            todayTableView.register(UINib(nibName: Category3Cell.className, bundle: nil), forCellReuseIdentifier: Category3Cell.cellId)
        }
    }
